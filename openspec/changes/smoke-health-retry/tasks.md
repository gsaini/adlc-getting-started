...
- [ ] 1.2 Implement `waitForHealthy` in `scripts/lib/smoke.mjs`: backoff, deadline cut, final attempt at the deadline, per-attempt timeout of `min(5000, remaining)`, and exact log lines. Verify the 1.1 tests pass.
